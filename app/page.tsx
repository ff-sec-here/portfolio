    ...
    <div className="min-h-screen bg-background text-foreground relative">
      <nav className="fixed left-8 top-1/2 -translate-y-1/2 z-10 hidden lg:block">
        <div className="flex flex-col gap-4">
          {["intro", "work", "certifications", "blogs", "connect"].map((section) => (
            <button
              key={section}
      ...
      <main className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-16">
            ...
            <div className="lg:col-span-3 space-y-6 sm:space-y-8">
              ...
              <div className="space-y-6 max-w-md">
                <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed">
                  ...
                  <span className="text-foreground">infrastructure & cloud</span>, and{" "}
                  <span className="text-foreground">red team simulation</span>. Reported 100+ vulnerabilities across
            ...
            <div className="lg:col-span-2 flex flex-col justify-end space-y-6 sm:space-y-8 mt-8 lg:mt-0">
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="text-foreground">Vulnerability Researcher</div>
                  <div className="text-muted-foreground">@ Bugcrowd</div>
                  <div className="text-xs text-muted-foreground">Apr 2021 — Present</div>
                </div>
                <div className="space-y-2">
                  <div className="text-foreground">Vulnerability Researcher</div>
                  <div className="text-muted-foreground">@ HackerOne</div>
              ...
              {[
                {
                  ...
                  company: "Bugcrowd",
                  description:
                    "Reported 100+ vulnerabilities across web, API, and cloud targets with reproducible PoCs and impact focus.",
                  tech: ["Web", "API", "Cloud"],
                },
                {
                  year: "2021—Present",
                  ...
                  company: "HackerOne",
                  description:
                    "Independent offensive security research for public and private programs; documentation and triage collaboration.",
                  tech: ["Bug Bounty", "Recon", "PoC"],
                },
              ].map((job, index) => (
                <div
                  key={index}
        ...
        >
          <div className="space-y-12 sm:space-y-16">
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
              ...
              <div className="text-sm text-muted-foreground font-mono">EC‑Council</div>
            </div>
              ...
              {[
                {
                  ...
                  issuer: "EC-Council",
                  description: "Achieved EC-Council's highest penetration testing credential (LPT Master).",
                  tags: ["Network", "Web", "Ops"],
                },
                {
                  year: "2025",
                  name: "Certified Penetration Testing Professional (CPENT)",
                  issuer: "EC-Council",
                  description: "Advanced hands-on penetration testing across live ranges and complex environments.",
                  tags: ["Exploit Dev", "Pivoting", "OpsSec"],
                },
              ].map((cert, idx) => (
                <div
                  key={idx}
        ...
        >
          <div className="space-y-12 sm:space-y-16">
            <h2 className="text-3xl sm:text-4xl font-light">Writeups and Blogs</h2>
            <BlogSection />
          </div>
        </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 sm:gap-16">
            <div className="space-y-6 sm:space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <Link
                    href="https://www.linkedin.com/in/fahadbinfaisal/"
                    className="group flex items-center gap-3 text-foreground hover:text-muted-foreground transition-colors duration-300"
                  >
                    <span className="text-base sm:text-lg">linkedin.com/in/fahadbinfaisal</span>
                    <svg
